  ...
  const loadProfile = async () => {
    try {
      ...
      if (cachedUser) {
        ...
        setPhotoPreview(cachedUser.profilePhoto || null);
      }
      ...
      const profileData = {
        ...
        profilePhoto: profile.profilePhoto || profile.data?.profilePhoto || null
      };
        ...
        {loading ? (
          ...
          <div className="modern-avatar-section">
            <div className="modern-avatar-wrapper">
              ...
              {isEditing && (
                <div className="modern-avatar-controls">
                  <label htmlFor="profile-photo" className="modern-avatar-upload">
                    <Camera size={18} />
                  </label>
                  <input
                    id="profile-photo"
                  ...
                  {photoPreview && (
                    <button 
                      type="button"
                      className="modern-avatar-remove"
                      onClick={removePhoto}
                    >
                      <X size={16} />
                    </button>
